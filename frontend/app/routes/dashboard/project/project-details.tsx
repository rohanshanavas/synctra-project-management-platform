            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-1">
                        {task.status !== "To Do" && (
                            <Button variant="ghost" size="icon" className="size-6" title="Mark as To Do" onClick={() => {
                                console.log("Marking as To Do");
                            }}>
                        ...
                        {task.status !== "In Progress" && (
                            <Button variant="ghost" size="icon" className="size-6" title="Mark as In Progress" onClick={() => {
                        ...
                        {task.status !== "Done" && (
                            <Button variant="ghost" size="icon" className="size-6" title="Mark as Done" onClick={() => {
            ...
            <CardContent>
                ...
                { task.subtasks && task.subtasks.length > 0 && (
                    <div className="mt-2 text-xs text-muted-foreground">
                        <span className="text-xs text-muted-foreground">
                            {task.subtasks.filter((subtask) => subtask.completed).length} / {task.subtasks.length} subtasks completed
                        </span>
                    </div>
                )}
            </CardContent>
